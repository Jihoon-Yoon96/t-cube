 ...
 * 이미지/PDF 디자인 시안의 HTML 생성, 요청 취소, 변환 결과 반영 흐름 관리
 */
...
type BuilderHtmlGenerationNuxtApp = ReturnType<typeof useNuxtApp> & {
...
export function useBuilderHtmlGeneration() {
  ...
  const nuxtApp = useNuxtApp() as BuilderHtmlGenerationNuxtApp
